...
#'    least 40 sequntial residues. 55 protein families with LDRs were used to
...
#'    when ranking its preformance, it preformed the best in alignming proteins
#'    woth less than 50\% sequence identity. Please see the source material,
...
#'    Matrix.
#' @format A symetrical matrix. 20x20 representing the 20 standard amino acids
#' @section Optimal Gap Parameters:
#'   These values were described in the source article, and reported in Table 2.
#'   After the optimal parameters were determined, the authors futher refined
#'   the gap costs.
#'   Therefore, it is reccomended to use these parameters for any alignment
#'   utilizing this matrix. These were:
#'   \tabular{ccc}{
#'   DUNMat \tab Gap Open \tab Gap Extensoin \cr
