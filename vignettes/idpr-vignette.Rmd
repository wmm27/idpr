...
disorder of a protein sequence (12-14).
...
user specification, and fasta files will be loaded using the read.fasta function
from the ‘seqinr’ package (21). Additionally, all visualizations generated by 
...
and dynamic results. Additionally, this package also includes tools for 
